...
from supar.models import SimplestBiaffineDependencyModel
...
class SimplestBiaffineDependencyParser(Parser):
    r"""
    ...
    NAME = 'simplest-biaffine-dependency'
    MODEL = SimplestBiaffineDependencyModel

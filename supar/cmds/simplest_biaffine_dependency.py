...
from supar import SimplestBiaffineDependencyParser
...
def main():
    ...
    parser.set_defaults(Parser=SimplestBiaffineDependencyParser)
    ...
    subparser.add_argument('--train', default='../../data/universal_treebanks_v2.0/std/en/en-universal-train.conll', help='path to train file')
    subparser.add_argument('--dev', default='../../data/universal_treebanks_v2.0/std/en/en-universal-dev.conll', help='path to dev file')
    subparser.add_argument('--test', default='../../data/universal_treebanks_v2.0/std/en/en-universal-test.conll', help='path to test file')
    ...
    subparser.add_argument('--bert', default='xlm-roberta-large', help='which bert model to use')
    # evaluate
    subparser = subparsers.add_parser('evaluate', help='Evaluate the specified parser and dataset.')
    subparser.add_argument('--punct', action='store_true', help='whether to include punctuation')
    subparser.add_argument('--buckets', default=8, type=int, help='max num of buckets to use')
    subparser.add_argument('--data', default='../../data/universal_treebanks_v2.0/std/en/en-universal-test.conll', help='path to dataset')
    # predict
